...
export const metadata: Metadata = { title: "Privacy Policy — FRENZY" };

export default function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy" updated="August 2026">
      <p>
        This Privacy Policy explains what information FRENZY collects during the global
        pre-registration period for the Road to Paris 2027 competition, and how that
        information is used.
      </p>
      ...
      <section>
        ...
        <p className="mt-2">
          We use this information to build the FRENZY pre-registration list, plan the
          Road to Paris 2027 competition, and — if you opted in — send you updates about
          FRENZY. We do not use this information for any automated decision-making that
      ...
      <section>
        ...
        <p className="mt-2">
          ...
          FRENZY team. We do not sell your personal information. We may share aggregated,
      ...
      <section>
        ...
        <p className="mt-2">
          ...
          contacting us at{" "}
          <a href="mailto:privacy@frenzy.gg" className="underline">
            privacy@frenzy.gg
          </a>
